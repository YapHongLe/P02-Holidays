    ...
    public View getView(int position, View convertView, ViewGroup parent) {
        ...
        if (currentType.getHoliType().equals("Secular")) {
            ...
            if (position == 0) {
                ...
                ivHoli.setImageResource(R.drawable.goodfriday);
            } else if (position == 2) {
                ivHoli.setImageResource(R.drawable.vesakday);
            } else if (position == 3) {
                ivHoli.setImageResource(R.drawable.harirayapuasa);
            } else if (position == 4) {
                ivHoli.setImageResource(R.drawable.harirayahaji);
            } else if (position == 5) {
                ivHoli.setImageResource(R.drawable.deepavali);
            } else if (position == 6) {
                ivHoli.setImageResource(R.drawable.christmastree);
            }
